...
import { NavData } from "./navbar.types";
              ...
              {data.map((d) => {
                return (
                  <li key={d.title}>
                    <a
                      href={d.link}
                      className="block py-2 px-3 text-black bg-white-700 rounded md:bg-transparent md:text-black-700 md:p-0 light:text-white md:light:text-black-500"
                      aria-current="page"
